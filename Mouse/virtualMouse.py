...
api_key = "51364a1e68ed4b619722b3bbfeed471f"
...
def start_virtual_mouse():
    ...
    while is_stopped == False:
        ...
        if len(lmlist)!=0:
            ...
            if fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 0 and fingers[4] == 0 and fingers[0] == 0:     # If fore finger & middle finger both are up
            ...
            if fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 0 and fingers[0] == 0:
                ...
                if length < 40:     # If both fingers are really close to each other
                    cv2.circle(img, (lineInfo[4], lineInfo[5]), 15, (0, 255, 0), cv2.FILLED)
                    autopy.mouse.click(autopy.mouse.Button.RIGHT)    # Perform Click
